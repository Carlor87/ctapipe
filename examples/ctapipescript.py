...
if __name__ == "__main__":
    ...
    with event_source("/home/cromoli/Documents/hessfits/pks2155flarerun_wImages_test.hap/run_00033746_televentlist_img.fits.gz") as source:
...
#                teltheta[j]=event.pointing.altitude*u.deg
            ...
            # shower = hillasReco.predict(hillas_dict=HillasIm,inst=event.inst,tel_phi=telphi,tel_theta=teltheta) # for method 1
